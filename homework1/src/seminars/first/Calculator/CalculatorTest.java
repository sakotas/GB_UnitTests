...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        assertThat(Calculator.calculatingDiscount(100.00, 5)).isEqualTo(95);
        assertThat(Calculator.calculatingDiscount(100.00, 101)).isInstanceOf(ArithmeticException.class);
        assertThat(Calculator.calculatingDiscount(0, 0)).isInstanceOf(ArithmeticException.class);
        assertThat(Calculator.calculatingDiscount(-100, 0)).isInstanceOf(ArithmeticException.class);
